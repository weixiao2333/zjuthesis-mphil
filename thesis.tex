...
\title{跨界服务平台中服务智能调用的研究}
% 如果标题一行写不下，就写成两行，在下面的命令里写第二行，不需要两行则注释掉
% \titletl{——东方视角分析}

%英文题目
\Etitle{Research on Service Intelligent Invocation in Crossover Service Platform}
...
% 导师
\supervisor{尹建伟}
\Esupervisor{Master JianWei Yin}
